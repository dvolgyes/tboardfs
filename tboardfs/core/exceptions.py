...
class InvalidFileFormatError(DataSourceError):
    ...
    def __init__(self, file_path: str | Path, expected_format: str | None = None):
        ...
        super().__init__(msg, {"file_path": str(self.file_path), "expected_format": expected_format})
...
class EventParsingError(ParsingError):
    ...
    def __init__(self, event_file: str | Path, step: int | None = None, tag: str | None = None, cause: Exception | None = None):
...
class TensorDecodingError(ParsingError):
    ...
    def __init__(self, tag: str, tensor_type: str | None = None, cause: Exception | None = None):
...
class UnsupportedFormatError(ExportError):
    ...
    def __init__(self, format_type: str, data_type: str | None = None, supported_formats: list[str] | None = None):
...
class DataValidationError(ValidationError):
    ...
    def __init__(self, data_type: str, field: str | None = None, expected: Any | None = None, actual: Any | None = None):
...
class PipelineStageError(ProcessingError):
    ...
    def __init__(self, stage_name: str, input_data: Any | None = None, cause: Exception | None = None):
